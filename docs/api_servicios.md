...
## ActiveWindowService
**Ruta:** `src/services/ActiveWindowService.ts`
...
**Ruta:** `src/services/events/CoPresenceDetectionService.ts`
...
**Ruta:** `src/services/events/EventIngestionService.ts`
...
**Ruta:** `src/services/events/PatternDetectionService.ts`
...
## PurgeService
**Ruta:** `src/services/PurgeService.ts`
...
## RecognitionService
**Ruta:** `src/services/RecognitionService.ts`
...
## RevelationService
**Ruta:** `src/services/RevelationService.ts`
...
## SafetyService
**Ruta:** `src/services/SafetyService.ts`
...
**Ruta:** `src/services/WindowDecisionService.ts`
...
**Ruta:** `src/services/WindowProposalService.ts`
