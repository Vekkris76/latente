...
La IA DEBE leer y respetar estos documentos, en este orden:
	1.	../product/objetivo.md
	2.	../product/spec-funcional.md
	3.	../phases/fase0/00_DECISIONES_V1.md (CERRADO)
	4.	../phases/fase0/01_ABSTRACCION_DATOS.md (CERRADO)
	5.	../phases/fase0/02_DEFINICION_PATRONES.md (CERRADO)
	6.	../phases/fase0/03_COPRESENCIA_REGLAS.md (CERRADO)
	7.	../phases/fase0/04_PROPUESTAS_VENTANA.md (CERRADO)
	8.	../phases/fase0/05_DECISIONES_VENTADA.md (CERRADO)
	9.	../phases/fase0/06_VENTANA_ACTIVA.md (CERRADO)
	10.	../phases/fase0/07_RECONOCIMINETO.md (CERRADO)
	11.	../phases/fase0/08_REVELACION.md (CERRADO)
	12.	../phases/fase0/09_UI_SPEC.md (CERRADO)
	13.	../phases/fase0/10_MODELO_DATOS_FUNCIONAL.md (CERRADO)
	14.	../phases/fase0/11_RETENCION_PURGA.md (CERRADO)
	15.	../phases/fase0/12_CONSENTIMIENTOS.md (CERRADO)
	16.	../phases/fase1/VALIDACION_FASE1.md (APROBADA)
