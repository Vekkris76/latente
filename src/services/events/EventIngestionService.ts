...
import { AbstractEventInput, AbstractEvent } from '../../types/AbstractEvent.types';
import { AbstractEventValidator } from '../../validation/AbstractEventValidator';
import { EventRepository } from '../../repositories/EventRepository';

export class EventIngestionService {
  constructor(
    private readonly eventRepository: EventRepository,
    private readonly validator: AbstractEventValidator
  ) {}
