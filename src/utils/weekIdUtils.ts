 ...
 * Rango semana: 01-53
 */
export function validateWeekIdFormat(week_id: string): boolean {
 ...
 */
export function computeSpanWeeks(first: string, last: string): number {
 ...
 */
export function checkWithin4WeeksSpan(weekIds: string[]): boolean {
